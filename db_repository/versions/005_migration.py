...
user = Table('user', post_meta,
    ...
    Column('social_name', String(length=64)),
    Column('user_url', String(length=64)),
)
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['user'].columns['user_url'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['user'].columns['user_url'].drop()
